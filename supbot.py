...
if __name__ == "__main__":
	...
	add_to_cart("Large", "Box Logo Hooded Sweatshirt", "sweatshirts", "Black")			#copy name exactly as said in news, color has first letter captilized, size has first letter capitlized
