...
if __name__ == "__main__":
	...
	"Telephone" : "972 977 7432",
	"Billing_Address" : "1804 Northern Oak Circle",
	"Billing_Zip" : "75063",
	"Billing_City" : "Irving",
	"Billing_State" : "TX",
	"Billing_Country" : "United States",
	"CCN" : "4610 4601 3846 8780",							#input card with spaces every 4 numbers
	"Card_Month" : "10",
	"Card_Year" : "2020",
	"Card_CC" : "633"
	}

	username = "andyprevalsky1@gmail.com"					#fill in with your gmail account
	...
	add_to_cart("Medium", "Supreme®/Nike®/NBA Shooting Sleeve", "accessories", "Black")			#copy name exactly as said in news, color has first letter captilized, size has first letter capitlized
